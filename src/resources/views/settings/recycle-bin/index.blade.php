            ...
            <table class="table">
                ...
                <tr>
                    <td>
                        ...
                        @if($deletion->deletable instanceof \App\Entities\Models\Book || $deletion->deletable instanceof \App\Entities\Models\Chapter)
                            <div class="mb-m"></div>
                        @endif
                        @if($deletion->deletable instanceof \App\Entities\Models\Book)
