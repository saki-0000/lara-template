...
<div page-picker>
    <div class="input-base">
        ...
        <a @if(!$value) style="display: none" @endif href="{{ url('/link/' . $value) }}" target="_blank" rel="noopener" class="text-page" page-picker-display>#{{$value}}, {{$value ? \App\Entities\Models\Page::find($value)->name : '' }}</a>
    </div>
    <br>
