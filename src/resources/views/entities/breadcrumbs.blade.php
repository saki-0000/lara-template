<nav class="breadcrumbs text-center" aria-label="{{ trans('common.breadcrumb') }}">
    ...
    @if (count($crumbs) > 0 && ($crumbs[0] ?? null) instanceof  \App\Entities\Models\Book)
    ...
    @if (count($crumbs) > 0 && ($crumbs[0] ?? null) instanceof  \App\Entities\Models\Bookshelf)
    ...
    @foreach($crumbs as $key => $crumb)
        <?php $isEntity = ($crumb instanceof \App\Entities\Models\Entity); ?>
