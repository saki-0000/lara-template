        ...
        <div class="grid third gap-xxl">
            <div>
                <div class="card mb-xl">
                    ...
                    <div class="px-m">
                        @include('entities.list', ['entities' => (new \App\Entities\Queries\Popular)->run(10, 0, ['page']), 'style' => 'compact'])
                    </div>
                </div>
            </div>
            <div>
                <div class="card mb-xl">
                    ...
                    <div class="px-m">
                        @include('entities.list', ['entities' => (new \App\Entities\Queries\Popular)->run(10, 0, ['book']), 'style' => 'compact'])
                    </div>
                </div>
            </div>
            <div>
                <div class="card mb-xl">
                    ...
                    <div class="px-m">
                        @include('entities.list', ['entities' => (new \App\Entities\Queries\Popular)->run(10, 0, ['chapter']), 'style' => 'compact'])
                    </div>
                </div>
            </div>
        </div>
